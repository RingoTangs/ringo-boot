...
- `spring-commons-autoconfigure/`: Web APIs live under `io.github.ringotangs.springcommons.web`; Spring Boot configuration and optional localization live under `io.github.ringotangs.springcommons.autoconfigure.web`.
