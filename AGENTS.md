...
- `spring-commons-autoconfigure/`: Spring Boot auto-configuration, Web exception handling, and optional localization under `src/main/java/io/github/ringotangs/springcommons/web`.
