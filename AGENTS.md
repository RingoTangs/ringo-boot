...
- `spring-commons-autoconfigure/`: Spring Boot configuration, Web exception handling, and optional localization live under `io.github.ringotangs.springcommons.autoconfigure`.
